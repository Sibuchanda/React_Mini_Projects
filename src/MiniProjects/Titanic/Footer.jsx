      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <nav className="mb-4 md:mb-0">
          <ul className="flex space-x-6">
            <li>
              <NavLink to="/service" className="hover:text-yellow-400 transition duration-300">
                Services
              </NavLink>
            </li>
            <li>
              <NavLink to="/about" className="hover:text-yellow-400 transition duration-300">
                About Us
              </NavLink>
            </li>
            <li>
              <NavLink to="/contact" className="hover:text-yellow-400 transition duration-300">
                Contact Us
              </NavLink>
            </li>
          </ul>
